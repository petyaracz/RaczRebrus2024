...
Stem-level similarity and the presence of a suffix-initial vowel together predict back/front ratios across forms in the data.

We better understand the role of the KNN predictions and the suffix-initial vowel if we visualise the predictions of the best model in Figure 2.
...
ggsave('viz/fig2.pdf', width = 6, height = 4)
...
p1 = u %>% 
  ...
  geom_label(position = position_nudge(x = .25)) +
  theme_bw() +
...
ggsave('viz/fig5.pdf', width = 8, height = 3)
...
u %>% 
  ...
  scale_colour_colorblind() +
  ylab('sd(back/front)') +
  ggtitle('Figure 6. Standard deviations of overall back/front preference\nfor consonant- and vowel-initial suffixes')

ggsave('viz/fig6.pdf', width = 4, height = 4)
```